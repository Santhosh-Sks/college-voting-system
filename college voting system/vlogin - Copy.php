...
<a href="#" id="logo">ONLINE ELECTION PORTAL</a>
<nav>
	<ul>
			...
			<div class="wrap-login100 p-t-50 p-b-90">
				<form method="post" action="#" class="login100-form validate-form flex-sb flex-w">
					...
					<div class="container-login100-form-btn m-t-17">
						...
						<div class="container-login100-form-btn m-t-17">
						<a href="signup.php" class="login100-form-btn">Signup</a>
					</div>
...
$sql = "SELECT * FROM login where  username='$uname' and password='$pass'  and role='user'";
...
$role=$row["role"];
 ...
 header("Location: http://localhost/election/vdashboard.php");
